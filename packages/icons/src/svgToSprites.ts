...
import generateSymbol from "./converterUtils/generateSymbol";
    ...
    if (Object.prototype.hasOwnProperty.call(svgPathsByGroup, groupName)) {
      ...
      spriteStream.on("open", () => {
        ...
        for (const svgPath of svgPaths) {
          ...
          const colorObject = colorExtractor(svgData);
          const svgWithCssVars = fillColorReplacer(svgData, colorObject);
